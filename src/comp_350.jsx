...
export class COMP_350 extends React.Component {    
  ...
  <div class="three"><center>
    Course Desciption
  <h3>
  This is an introduction to the theory and practice of operating system design and implementation. Algorithmic techniques are presented for implementing process management, storage management, processor management, file systems, security, distributed systems, performance evaluation, and real time systems.  </h3>
