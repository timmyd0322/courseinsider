...
export class COMP_280 extends React.Component {    
  ...
  <div class="three"><center>
    Course Desciption
  <h3>
  This course makes use of abstractions (algorithm, data type) and programming tools (pointers, dynamic memory, and linked data structures). This course examines essential data structures (stacks, queues, trees, linked lists, and graphs). It analyzes and implements techniques such as hashing, sorting , searching, and priority queues to solve general problems. The emphasis of the course is on building computer programs that use the essential data structures.   </h3>
