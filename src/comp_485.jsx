...
export class COMP_485 extends React.Component {    
  ...
  <div class="three"><center>
    Course Desciption
  <h3>
  This course permits the exploration of advanced topics pertinent to student¿s program of study in a seminar setting.  </h3>
