...
export class COMP_161 extends React.Component {    
  ...
  <div class="three"><center>
    Course Desciption
  <h3>
  This course teaches the Python programming language along with an environment and standards that encourage efficient production of well-developed code. The course addresses numerical computing, data manipulation and analysis, plotting and visualization, machine learning, and language processing by focusing on the most important Python libraries (e.g., NumPy, pandas, Matplotlib, ggplot2, statsmodels, scikit-learn, and NLTK) that enable the student to do data science effectively using Python. 
  </h3>
