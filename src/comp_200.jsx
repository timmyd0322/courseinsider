...
export class COMP_200 extends React.Component {    
  ...
  <div class="three"><center>
    Course Desciption
  <h3>
  This course provides the students with exposure to current issues in computer science. Colloquium speakers include visitors and faculty.  </h3>
